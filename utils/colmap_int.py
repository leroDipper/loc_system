...
if __name__ == "__main__":
    # Configuration
    dataset_path = '/home/leroy/masters_local/loc_system/resources/mh_01/images'
    output_dir = '/home/leroy/masters_local/loc_system/resources/mh_01'

    # Create output directory
    os.makedirs(output_dir, exist_ok=True)
    db_path = os.path.join(output_dir, 'mh_01.db')
