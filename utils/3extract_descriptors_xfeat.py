...
# Connect to database
conn = sqlite3.connect('resources/mh_01/mh_01.db')
cursor = conn.cursor()

# Create output directory
os.makedirs('resources/mh_01/project_files/descriptors', exist_ok=True)
...
for img_id, img_name in images:
    ...
    if result:
        ...
        # Save as text file
        output_file = f'resources/mh_01/project_files/descriptors/{img_name}_desc.txt'
