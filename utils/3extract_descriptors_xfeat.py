...
# Connect to database
conn = sqlite3.connect('resources/mh_03/database_mh_03_500f.db')
cursor = conn.cursor()

# Create output directory
os.makedirs('resources/mh_03/project_files/descriptors', exist_ok=True)
...
for img_id, img_name in images:
    ...
    if result:
        ...
        # Save as text file
        output_file = f'resources/mh_03/project_files/descriptors/{img_name}_desc.txt'
