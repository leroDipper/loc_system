...
def main():
    map_root = '/home/leroy-marewangepo/colmap_database/figure_8_map/'
    # Load map
    print("Loading map...")
    ...
    result, error = localiser.localise(dataset_root + 'left/frame_0010.jpg')
    ...
    images = [
        dataset_root + 'left/frame_0001.jpg',
        dataset_root + 'left/frame_0010.jpg',
        dataset_root + 'left/frame_0060.jpg',
    ]
