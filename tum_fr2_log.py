...
if __name__ == "__main__":
    scale, R, t = GroundTruthParams.load_transformation('resources/tum_fr2/project_files/colmap_to_gt_transform.json')
    ...
    vocabulary = 'resources/tum_fr2/vocabularies/vocab_tree_master.bin'
    ...
    print("\n" + "="*60)
    print("CONTINUOUS LOCALISATION TEST - tum_fr2 SEQUENCE")
    print("="*60)

    # Load COLMAP reconstructed images
    colmap_images = load_colmap_image_names('resources/tum_fr2/project_files/images.txt')
    ...
    if len(errors) > 0:
        ...
        if len(results_log) > 0:
            ...
            uncertainty_df.to_csv('results/tum_fr2_uncertainty250.csv', index=False)
            print(f"\n✓ Saved detailed data to results/tum_fr2_uncertainty250.csv")
