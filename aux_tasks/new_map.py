...
with open('resources/mh_03/project_files/images.txt', 'r') as f:
    colmap_images = []
    for line in f:
...
all_frames = sorted(glob.glob('resources/mh_03/images/*.png'))
...
map_3d_points, map_descriptors, map_track_lengths, map_ba_errors = map_builder.build_map_database(
    map_files='resources/mh_03/project_files',
    dataset_path='resources/mh_03/images',
    descriptors_path='resources/mh_03/project_files/descriptors',
    save_to='resources/mh_03/map_databases/mh_03_master.npz',
