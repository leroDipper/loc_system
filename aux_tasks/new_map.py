...
with open('resources/tum_fr3/project_files/images.txt', 'r') as f:
    colmap_images = []
    for line in f:
...
train_images = set(colmap_images[:2000]) 
test_images = set(colmap_images[2000:])   
...
map_3d_points, map_descriptors = map_builder.build_map_database(
    ...
    save_to='resources/tum_fr3/map_databases/tum_fr3_train.npz',
