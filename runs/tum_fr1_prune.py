...
if __name__ == "__main__":
    scale, R, t = GroundTruthParams.load_transformation('resources/tum_fr1/colmap_to_gt_transform_prune_na.json')
    ...
    vocabulary = 'resources/tum_fr1/vocabularies/vocab_tree_tum_fr1_prune.bin'
    print("Loaded existing vocabulary")

    # Load colmap map
    data = np.load('resources/tum_fr1/map_databases/feat_selec/tum_fr1_prune.npz')
    ...
    colmap_images_path = 'resources/tum_fr1/sparse_text/images.txt'
    registered_images = []
