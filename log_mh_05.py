...
if __name__ == "__main__":
    ...
    vocabulary = 'resources/mh_05/vocabularies/vocab_tree_master.bin'
    ...
    print("\n" + "="*60)
    print("CONTINUOUS LOCALISATION TEST - mh_05 SEQUENCE")
    print("="*60)
    ...
    if len(errors) > 0:
        ...
        if len(results_log) > 0:
            ...
            uncertainty_df.to_csv('results/mh_05_uncertainty250.csv', index=False)
            print(f"\n✓ Saved detailed data to results/mh_05_uncertainty250.csv")
