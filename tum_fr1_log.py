...
if __name__ == "__main__":
    ...
    data = np.load('resources/tum_fr1/map_databases/tum_fr1_master.npz')
    ...
    print("\n" + "="*60)
    print("CONTINUOUS LOCALISATION TEST - tum_fr1 SEQUENCE")
    print("="*60)
    ...
    if len(errors) > 0:
        ...
        if len(results_log) > 0:
            ...
            uncertainty_df.to_csv('results/tum_fr1_uncertainty550.csv', index=False)
            print(f"\n✓ Saved detailed data to results/tum_fr1_uncertainty550.csv")
